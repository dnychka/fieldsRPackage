...
##########################################################################################
     for (k in 1:M) {
       if( k%%10 ==0 ){
        ...
        #
        # print( localError[1:10])
        # print( localObject$B[1,1:50])
        # print(hTrue[1:10])
        # print( localObject$SE[1:10])
        # 
        ...
        tmpError<- (spatialPrediction  - hTrue)
        # hHat is of course the conditional mean ...
        out[,, k] <- (hHat + tmpError)[indexSubset$x,indexSubset$y]
     }
